...
EQUIPOS {
  ...
  equipo: "Águilas United" [
    jugador: "Diego Ramírez" [posicion: "DELANTERO", numero: 9, edad: 28],
  ...
  equipo: "Tigres Academy" [
    jugador: "Andrés Pérez" [posicion: "DELANTERO", numero: 11, edad: 24],
...
let lexerPrueba = new Lexer(entrada);
let resultado = lexerPrueba.analizarEntradaDeTexto();
