...
function consumirListaJugadores(TStream,equipo){
    ...
    nombreJugador=TStream.tipoEsperado("Cadena").lexema;//si el tipo del token es una cadena, me devuelve le token y accedo a su lexema para tener su nombre

    TStream.lexemaEsperado("[");

    //Este metodo me devuelve un lexema, en este caso el texto que me indica en que posicion juega el don
    posicionDelJugador=consumirCadena(TStream,"posicion")//Esta funcin la creamos abajo
    ...
    //--------------------
    numeroDelJugador=consumirNumero(TStream,"numero");
    TStream.lexemaEsperado(","); //estas comas seperan los atributos en el archivo

    edad=consumirNumero(TStream,"edad");
